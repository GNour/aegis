...
Harness needs auditable canonical knowledge, efficient exact document retrieval,
...
memories and hierarchical context. Harness is the only writer to canonical
...
Harness must run two indexes, deduplicate context, enforce collection ACLs,
