...
decisions receive the next four-digit identifier.

| ADR | Decision | Status |
|---|---|---|
| [0001](0001-isolate-harness-service-users.md) | Isolate gateway and worker plane | accepted |
| [0002](0002-config-driven-harness-flows.md) | Use versioned declarative flows | accepted |
